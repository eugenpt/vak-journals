...
При сборке JSON дополнительно подтягиваются ссылки на **паспорта научных специальностей** из официального API ВАК (`type=17`) и добавляются в карточки специальностей, если код специальности найден в текущей номенклатуре.
