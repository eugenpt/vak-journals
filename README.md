...
2. В [`docs/site-config.js`](docs/site-config.js) указать `metrikaId: 12345678`.
3. Закоммитить и задеплоить.

Пока `metrikaId: null` — счётчик **не** загружается. В подвале появится ссылка на политику Яндекса, когда счётчик включён.
